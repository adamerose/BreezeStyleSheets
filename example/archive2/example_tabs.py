...
# self implementation generated from reading ui file 'example_tabs.ui'
#
...
class Example(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.tabWidgetEast_2 = QtWidgets.QTabWidget(self)
        self.tabWidgetEast_2.setEnabled(False)
        self.tabWidgetEast_2.setGeometry(QtCore.QRect(302, 260, 274, 133))
        ...
        self.label_6.setGeometry(QtCore.QRect(302, 11, 274, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_6.setFont(font)
        self.label_6.setObjectName("label_6")
        self.tabWidgetSouth = QtWidgets.QTabWidget(self)
        self.tabWidgetSouth.setGeometry(QtCore.QRect(20, 400, 275, 78))
        ...
        self.tabWidgetSouth_2 = QtWidgets.QTabWidget(self)
        self.tabWidgetSouth_2.setEnabled(False)
        self.tabWidgetSouth_2.setGeometry(QtCore.QRect(302, 400, 274, 78))
        ...
        self.tabWidgetWest_2 = QtWidgets.QTabWidget(self)
        self.tabWidgetWest_2.setEnabled(False)
        self.tabWidgetWest_2.setGeometry(QtCore.QRect(302, 120, 274, 133))
        ...
        self.tabWidgetNorth_2 = QtWidgets.QTabWidget(self)
        self.tabWidgetNorth_2.setEnabled(False)
        self.tabWidgetNorth_2.setGeometry(QtCore.QRect(302, 34, 274, 79))
        ...
        self.tabWidgetEast = QtWidgets.QTabWidget(self)
        self.tabWidgetEast.setGeometry(QtCore.QRect(20, 260, 275, 133))
        ...
        self.tabWidgetNorth = QtWidgets.QTabWidget(self)
        self.tabWidgetNorth.setGeometry(QtCore.QRect(20, 34, 275, 79))
        ...
        self.label_5.setGeometry(QtCore.QRect(20, 11, 275, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.tabWidgetWest = QtWidgets.QTabWidget(self)
        self.tabWidgetWest.setGeometry(QtCore.QRect(20, 120, 275, 133))
        ...
        self.tabWidgetNorth.setCurrentIndex(1)
        self.tabWidgetWest.setCurrentIndex(0)

        self.label_51.setText("Inside TabWidget East Tab 1")
        self.tabWidgetEast_2.setTabText(self.tabWidgetEast_2.indexOf(self.tab_13), "Tab 1")
        self.label_73.setText("Inside TabWidget East Tab 2")
        self.tabWidgetEast_2.setTabText(self.tabWidgetEast_2.indexOf(self.tab_14), "Tab 2")
        self.label_6.setText("Disabled")
        self.label_34.setText("Inside TabWidget South Closable Tab 1")
        self.tabWidgetSouth.setTabText(self.tabWidgetSouth.indexOf(self.tab), "Tab 1")
        self.label_62.setText("Inside TabWidget South Closable Tab 2")
        self.tabWidgetSouth.setTabText(self.tabWidgetSouth.indexOf(self.tab_2), "Tab 2")
        self.label_35.setText("Inside TabWidget South Closable Tab 1")
        self.tabWidgetSouth_2.setTabText(self.tabWidgetSouth_2.indexOf(self.tab_15), "Tab 1")
        self.label_74.setText("Inside TabWidget South Closable Tab 2")
        self.tabWidgetSouth_2.setTabText(self.tabWidgetSouth_2.indexOf(self.tab_16), "Tab 2")
        self.label_50.setText("Inside TabWidget West Tab 1")
        self.tabWidgetWest_2.setTabText(self.tabWidgetWest_2.indexOf(self.tab_11), "Tab 1")
        self.label_72.setText("Inside TabWidget West Tab 2")
        self.tabWidgetWest_2.setTabText(self.tabWidgetWest_2.indexOf(self.tab_12), "Tab 2")
        self.label_53.setText("Inside TabWidget North Closable Tab 1")
        self.tabWidgetNorth_2.setTabText(self.tabWidgetNorth_2.indexOf(self.tab_9), "Tab 1")
        self.label_49.setText("Inside TabWidget North Closable Tab 2")
        self.tabWidgetNorth_2.setTabText(self.tabWidgetNorth_2.indexOf(self.tab_10), "Tab 2")
        self.label_38.setText("Inside TabWidget East Tab 1")
        self.tabWidgetEast.setTabText(self.tabWidgetEast.indexOf(self.tab_3), "Tab 1")
        self.label_55.setText("Inside TabWidget East Tab 2")
        self.tabWidgetEast.setTabText(self.tabWidgetEast.indexOf(self.tab_4), "Tab 2")
        self.label_52.setText("Inside TabWidget North Closable Tab 1")
        self.tabWidgetNorth.setTabText(self.tabWidgetNorth.indexOf(self.tab_7), "Tab 1")
        self.label_48.setText("Inside TabWidget North Closable Tab 2")
        self.tabWidgetNorth.setTabText(self.tabWidgetNorth.indexOf(self.tab_8), "Tab 2")
        self.label_5.setText("Enabled")
        self.label_39.setText("Inside TabWidget West Tab 1")
        self.tabWidgetWest.setTabText(self.tabWidgetWest.indexOf(self.tab_5), "Tab 1")
        self.label_54.setText("Inside TabWidget West Tab 2")
        self.tabWidgetWest.setTabText(self.tabWidgetWest.indexOf(self.tab_6), "Tab 2")
